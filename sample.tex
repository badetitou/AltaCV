...
\cvevent{Ingénieur de Recherche -- Ph.D.}{Berger-Levrault}{Novembre 2021 -- Aujourd'hui}{Lyon, FRANCE}
\begin{itemize}
...
J'ai aussi lancer en interne un projet d'analyse des logiciels de l'entreprise en utilisant la platforme de méta-modèlisation Moose.
...
\teachingevent{Fondamentaux architectures et systèmes d’exploitatio}{Polytech'Montpellier}{2020}{Montpellier, FRANCE}{2h}
