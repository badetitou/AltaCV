...
\begin{itemize}
\item Gestion de projets de recherche sur : IA pour le code, GreenIT, Modernisation
\item Management d'une équipe de chercheurs, d'ingénieurs et de doctorants
\item Élaboration de la feuille de route et planification
\item Collaboration avec des laboratoires de recherche et des business units
\end{itemize}
