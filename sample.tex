...
Gestion de projets de recherche et développement sur :
\begin{itemize}
\item \textbf{IA pour le code} : Intégration de l’IA dans les Merge Requests et les IDE ; utilisation de MCP et des fonctionnalités de tool-calling ; intégration de nouveaux tool-calling dans les IDE ; mesure de l’impact réel sur les équipes de production
\item \textbf{GreenIT} : Mesure de la consommation énergétique de l’infrastructure et du code
\item \textbf{Cartographie de l'architecture logiciel} : Représentation du code sous forme de cartes pour comprendre, planifier et moderniser des applications à très grande échelle
\end{itemize}

Gestion d’une équipe de 5 chercheurs et ingénieurs ainsi que de plusieurs doctorants
Planification de la feuille de route à long terme de l’équipe et pilotage de la collaboration avec plusieurs laboratoires de recherche (Inria) et unités industrielles.

\divider

\cvevent{Ingénieur R\&D}{Berger-Levrault}{Novembre 2021 -- Décembre 2023}{Lyon, France}

\begin{itemize}
  \item Automatisation de la migration d’applications Java (GWT et Swing) de plus d’un million de lignes de code vers Angular
  \item Encadrement de doctorants et de stagiaires
  \item Rédaction de publications scientifiques
\end{itemize}
...
\cvevent{Pharo Language Server}{Personnel}{Décembre 2020 -- Aujourd'hui}{Grenoble, FRANCE}
\begin{itemize}
...
\cvevent{Pharo LibVLC}{Personnel}{Décembre 2020 -- Aujourd'hui}{Lille, FRANCE}

\begin{itemize}
\item Connecter Pharo avec VLC
\item Utilisation de librairie partagé et appel FFI
\end{itemize}
...
\cvtag{Analyse Architecture Logiciel}
...
Gestion d’une équipe de 5 chercheurs et ingénieurs ainsi que de plusieurs doctorants.
Encadrement de thèse sur: \textbf{Selection de tests} ; \textbf{Generation de tests} ; \textbf{Microservicisation d'application} ; \textbf{localisation de code métier}.
...
\begin{itemize}
  \item \url{https://modularmoose.org/blog/authors/benoit-verhaeghe/}
\end{itemize}
...
\cvevent{Pharo Language Server}{Projet personnel}{Décembre 2020 -- Aujourd'hui}{Grenoble, FRANCE}
\begin{itemize}
\item Connecter Pharo avec VSCode
