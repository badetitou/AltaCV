...
- Outil utilisant l'IDM permettant la migration d'application
...
Je suis donc resté en poste chez Berger-Levrault en tant qu'ingénieur de recherche afin de poursuivre les travaux de migration de logiciel, et de suivre les doctorants qui découlent de ce contrat cadre.
...
\cvevent{Pharo Language Server}{}{Décembre 2021 -- 2023}{Grenoble, FRANCE}
\begin{itemize}
\item Connecter Pharo avec VSCode
