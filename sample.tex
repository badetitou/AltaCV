...
Gestion de projets de recherche sur :
\break
\begin{itemize}
...
\end{itemize}
Gestion également d’une équipe de 5 chercheurs et ingénieurs ainsi que de plusieurs doctorants.
...
\begin{itemize}
  \item Migration d’applications Java (GWT et Swing) de plus d’un million de lignes de code vers Angular
